...
/* XshareSecurityBundle:Security:login.html.twig */
class __TwigTemplate_9ef34b8f47368d808d6f7e6e0e4e7c45 extends Twig_Template
{
    ...
    <h5>";
        // line 2
        echo $this->env->getExtension('translator')->getTranslator()->trans("Connect", array(), "messages");
        echo "</h5>
    ";
        // line 3
    ...
    <form action=\"";
        ...
        <div>
            <label for=\"username\">";
        // line 9
        echo $this->env->getExtension('translator')->getTranslator()->trans("Username or email", array(), "messages");
        echo "</label>
        ...
        // line 17
        echo twig_escape_filter($this->env, $this->getContext($context, "referer"), "html", null, true);
        echo "\" />
        <div class=\"login-button\"><input type=\"submit\" value=\"OK\" /></div>
    </form>
    <ul class=\"registration-links\">
        ...
        echo "\" class=\"liensGray\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("Register", array(), "messages");
        echo "</a></li>
        <li><a href=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_forgot_password"), "html", null, true);
        echo "\" class=\"liensGray\">";
    ...
    {
        return "XshareSecurityBundle:Security:login.html.twig";
    }
