...
class __TwigTemplate_e3ca2c92fafbd0a9cf4f635bf900f205 extends Twig_Template
{
    ...
    {
        // line 1
        if ((!twig_test_empty($this->getContext($context, "words")))) {
            // line 2
            echo "<div>
    <h5>";
            // line 3
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Top search"), "html", null, true);
            echo "</h5>
    <ul>
    ";
            // line 5
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "words"));
            foreach ($context['_seq'] as $context["_key"] => $context["word"]) {
                // line 6
                echo "        <li>
            <a class=\"liensGray\" href=\"";
                // line 7
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("general_search", array("searchWord" => $this->getAttribute($this->getContext($context, "word"), "keyword_search", array(), "array"))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "word"), "keyword_search", array(), "array"), "html", null, true);
                echo "</a>
        </li>
    ";
            }
...
";
    ...
    {
        return "XshareProductBundle:Search:topSearchList.html.twig";
    }
